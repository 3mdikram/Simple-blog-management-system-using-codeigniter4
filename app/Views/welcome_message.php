                            ...
                            <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="<?php echo base_url();?>/asset/website/images/slide/volunteer-helping.jpg" class="carousel-image img-fluid" alt="...">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo base_url();?>/asset/website/images/slide/volunteer-selecting.jpg" class="carousel-image img-fluid" alt="...">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo base_url();?>/asset/website/images/slide/collecting-donations.jpg" class="carousel-image img-fluid" alt="...">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 text-center mx-auto">
                            <h2 class="mb-5">Welcome to XYZ Company</h2>
                        </div>

                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="featured-block d-flex justify-content-center align-items-center">
                                <a href="donate.html" class="d-block">
                                    <img src="<?php echo base_url();?>/asset/website/images/icons/hands.png" class="featured-block-image img-fluid" alt="">

                                    <p class="featured-block-text">Become a <strong>our partner</strong></p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                            <div class="featured-block d-flex justify-content-center align-items-center">
                                <a href="donate.html" class="d-block">
                                    <img src="<?php echo base_url();?>/asset/website/images/icons/heart.png" class="featured-block-image img-fluid" alt="">

                                    <p class="featured-block-text"><strong>Live</strong> Sports</p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                            <div class="featured-block d-flex justify-content-center align-items-center">
                                <a href="donate.html" class="d-block">
                                    <img src="<?php echo base_url();?>/asset/website/images/icons/receive.png" class="featured-block-image img-fluid" alt="">

                                    <p class="featured-block-text">Make a <strong>responsive api</strong></p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="featured-block d-flex justify-content-center align-items-center">
                                <a href="donate.html" class="d-block">
                                    <img src="<?php echo base_url();?>/asset/website/images/icons/scholarship.png" class="featured-block-image img-fluid" alt="">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <img src="<?php echo base_url();?>/asset/website/images/group-people-volunteering-foodbank-poor-people.jpg" class="custom-text-box-image img-fluid" alt="">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="custom-block-wrap">
                                <img src="<?php echo base_url();?>/asset/website/images/causes/ipl_one.jpg" class="custom-block-image img-fluid" alt="">

                                <div class="custom-block">
                                    <div class="custom-block-body">
                                        <h5 class="mb-3">IPL</h5>
                                    ...
                                    <a href="#" class="custom-btn btn">IPL</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="custom-block-wrap">
                                <img src="<?php echo base_url();?>/asset/website/images/causes/basketball.jfif" class="custom-block-image img-fluid" alt="">

                                <div class="custom-block">
                                    <div class="custom-block-body">
                                        <h5 class="mb-3">Basketball</h5>
                                    ...
                                    <a href="#" class="custom-btn btn">Basketball</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="custom-block-wrap">
                                <img src="<?php echo base_url();?>/asset/website/images/causes/kabaddi.jpg" class="custom-block-image img-fluid" alt="">

                                <div class="custom-block">
                                    <div class="custom-block-body">
                                        <h5 class="mb-3">Kabaddi</h5>
                                    ...
                                    <a href="donate.html" class="custom-btn btn">Kabaddi</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <form class="custom-form volunteer-form mb-5 mb-lg-0" action="#" method="post" role="form">
                                <h3 class="mb-4">Become a our partner</h3>
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <input type="text" name="volunteer-name" id="volunteer-name" class="form-control" placeholder="Karan" required>
                                    </div>

                                    <div class="col-lg-6 col-12">    
                                        <input type="email" name="volunteer-email" id="volunteer-email" pattern="[^ @]*@[^ @]*" class="form-control" placeholder="support@entitysport.com" required>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="input-group input-group-file">
                                            ...
                                            <label class="input-group-text" for="inputGroupFile02">Upload your Doc</label>
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="<?php echo base_url();?>/asset/website/images/kohli.webp" class="volunteer-image img-fluid" alt="">

                            <div class="custom-block-body text-center">
                                <h4 class="text-white mt-lg-3 mb-lg-3">About Our Partner</h4>
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="news-block">
                                <div class="news-block-top">
                                    <a href="#">
                                        <img src="<?php echo base_url();?>/asset/website/images/ipl_one.jpg" class="news-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="news-block-info">
                                    ...
                                    <div class="news-block-title mb-2">
                                        <h4><a href="#" class="news-block-title-link"> IPL Latest News</a></h4>
                                    </div>
                            ...
                            <div class="news-block mt-3">
                                <div class="news-block-top">
                                    <a href="#">
                                        <img src="<?php echo base_url();?>/asset/website/images/kabaddi.jpg" class="news-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="news-block-info">
                                    ...
                                    <div class="news-block-title mb-2">
                                        <h4><a href="#" class="news-block-title-link">Kabaddi latest news</a></h4>
                                    </div>
                        ...
                        <div class="col-lg-4 col-12 mx-auto">
                            ...
                            <div class="news-block news-block-two-col d-flex mt-4">
                                ...
                                <div class="news-block-two-col-info">
                                    <div class="news-block-title mb-2">
                                        <h6><a href="#" class="news-block-title-link">IPL Latest News</a></h6>
                                    </div>
                            ...
                            <div class="news-block news-block-two-col d-flex mt-4">
                                <div class="news-block-two-col-image-wrap">
                                    <a href="#">
                                        <img src="<?php echo base_url();?>/asset/website/images/news/close-up-happy-people-working-together.jpg" class="news-image img-fluid" alt="">
                                    </a>
                                </div>

                                <div class="news-block-two-col-info">
                                    <div class="news-block-title mb-2">
                                        <h6><a href="#" class="news-block-title-link">Edu Latest News</a></h6>
                                    </div>
